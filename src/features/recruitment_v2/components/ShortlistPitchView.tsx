...
const ROLE_FULL_NAMES: Record<string, string> = {
  ...
  'MDCG': 'Milieu Défensif Gauche',
  'MDCD': 'Milieu Défensif Droit',
  'MC': 'Milieu Central',
  ...
  return (
    <div 
      ...
      className={cn(
        ...
        isFullscreen && "bg-slate-50 p-6 overflow-y-auto h-screen"
      )}
    >
      {/* Bandeau d'en-tête supprimé selon la demande (ShortlistPitchView V2) */}
      ...
      <div className="bg-white rounded-3xl p-4 border border-slate-200 shadow-xs flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5 w-full md:w-auto shrink-0 justify-end flex-wrap">
          ...
          <button
            ...
            className="p-1.5 rounded-xl border border-slate-200 bg-white text-slate-700 hover:bg-slate-100 hover:text-primary transition-colors shadow-sm ml-2"
      ...
      <div className="w-full relative bg-slate-50/50 p-2 sm:p-4 rounded-2xl sm:rounded-3xl border border-slate-200 shadow-sm overflow-x-auto no-scrollbar flex justify-center">
        <div 
          className="rounded-2xl sm:rounded-3xl relative overflow-hidden bg-gradient-to-b from-emerald-800 via-emerald-700 to-emerald-900 border-4 border-emerald-950 shadow-2xl select-none transition-all duration-300"
          style={{ 
        ...
        >
          ...
          <div className="absolute inset-3 sm:inset-5 border-2 border-white/75 rounded-2xl pointer-events-none">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 sm:w-36 sm:h-36 border-2 border-white/75 rounded-full" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 bg-white rounded-full shadow-xs" />

            {/* Surface de réparation NORD (Adversaire / Attaque) */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-56 sm:w-72 h-28 sm:h-36 border-2 border-t-0 border-white/75 rounded-b-xl" />
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-24 sm:w-32 h-10 sm:h-14 border-2 border-t-0 border-white/75 rounded-b-lg" />
            <div className="absolute top-20 sm:top-28 left-1/2 -translate-x-1/2 w-2 h-2 bg-white rounded-full" />
            {/* Arc de cercle surface Nord */}
            <div className="absolute top-28 sm:top-36 left-1/2 -translate-x-1/2 w-20 sm:w-24 h-10 sm:h-12 border-2 border-t-0 border-white/75 rounded-b-full" />

            {/* Surface de réparation SUD (FUS / Gardien) */}
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-56 sm:w-72 h-28 sm:h-36 border-2 border-b-0 border-white/75 rounded-t-xl" />
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-24 sm:w-32 h-10 sm:h-14 border-2 border-b-0 border-white/75 rounded-t-lg" />
            <div className="absolute bottom-20 sm:bottom-28 left-1/2 -translate-x-1/2 w-2 h-2 bg-white rounded-full" />
            {/* Arc de cercle surface Sud */}
            <div className="absolute bottom-28 sm:bottom-36 left-1/2 -translate-x-1/2 w-20 sm:w-24 h-10 sm:h-12 border-2 border-b-0 border-white/75 rounded-t-full" />
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="mb-1.5 flex items-center gap-1">
                  <span 
                    className="text-[10px] sm:text-[11px] font-black uppercase text-white px-2 py-0.5 rounded-md bg-black/75 backdrop-blur-xs border border-white/30 shadow-md cursor-help"
                    title={ROLE_FULL_NAMES[slot.label] || slot.label}
                  >
                    {slot.label}
                  </span>
